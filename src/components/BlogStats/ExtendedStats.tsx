...
const ExtendedStats = ({
  ...
  return (
    <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
      <div className="group/item hover:transform hover:translate-y-[-0.5rem] transition-all duration-300 p-6 rounded-xl bg-gradient-to-br from-white to-green-50 dark:from-gray-800 dark:to-green-900/20 shadow-md hover:shadow-xl">
