...
interface CategoriesProps {
  totalPosts: number; // 确保包含 totalPosts
  ...
  ({
    ...
    const themeStyles = {
      light: {
        ...
        hoverBg: "hover:from-blue-100/50 hover:via-purple-100/50 hover:to-pink-100/50",
      ...
      dark: {
        ...
        hoverBg: "hover:from-blue-800/10 hover:via-purple-800/10 hover:to-pink-800/10",
      ...
      green: {
        ...
        hoverBg: "hover:from-emerald-100/50 hover:via-green-100/50 hover:to-teal-100/50",
      ...
      purple: {
        ...
        hoverBg: "hover:from-violet-100/50 hover:via-purple-100/50 hover:to-fuchsia-100/50",
      ...
      orange: {
        ...
        hoverBg: "hover:from-amber-100/50 hover:via-orange-100/50 hover:to-yellow-100/50",
      ...
      blue: {
        ...
        hoverBg: "hover:from-sky-100/50 hover:via-blue-100/50 hover:to-indigo-100/50",
      ...
      pink: {
        ...
        hoverBg: "hover:from-rose-100/50 hover:via-pink-100/50 hover:to-fuchsia-100/50",
      ...
      brown: {
        ...
        hoverBg: "hover:from-amber-100/50 hover:via-yellow-100/50 hover:to-orange-100/50",
        ...
        countBg: "from-amber-100/80 via-yellow-100/80 to-orange-100/80",
        activeCountBg: "from-amber-200/80 via-orange-200/80 to-yellow-200/80",
        countText: "text-amber-600 group-hover:text-amber-700",
        activeCountText: "text-amber-700",
        border: "border-amber-200/50",
    ...
    const baseClasses = `group flex items-center gap-2 px-4 py-2 rounded-xl transition-all duration-300 hover:scale-105 hover:shadow-lg border shadow-sm backdrop-blur-sm`;
...
function Categories({ totalPosts, currentCategory, categories, postsByCategory }: CategoriesProps) {
  const { getThemeClass } = useThemeUtils();
  ...
  const navBgClass = getThemeClass(
    "bg-white/20 hover:bg-white/30",
    {
      ...
      dark: "bg-gray-800/20 hover:bg-gray-800/30",
      green: "bg-emerald-50/20 hover:bg-emerald-50/30",
      purple: "bg-purple-50/20 hover:bg-purple-50/30",
      orange: "bg-orange-50/20 hover:bg-orange-50/30",
      blue: "bg-blue-50/20 hover:bg-blue-50/30",
      pink: "bg-pink-50/20 hover:bg-pink-50/30",
      brown: "bg-amber-50/20 hover:bg-amber-50/30",
    }
  );

  return (
    <nav
      className={`${navBgClass} backdrop-blur-md rounded-2xl p-4 shadow-lg border border-gray-200/50 hover:backdrop-blur-xl transition-all duration-500 ease-in-out sticky top-0 z-10 w-full max-w-[calc(100%-2rem)] mx-auto`}
    >
