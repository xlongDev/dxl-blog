...
export const quotes: Quote[] = [
  ...
  },
  {
    text: "总有些微光，会照亮前行的路。",
    translation:
      "There will always be a glimmer of light to illuminate the path ahead.",
  },
  {
    text: "人生如逆旅，我亦是行人。",
    translation:
      "Life is like a journey against the current; I am just a traveler.",
  },
  {
    text: "世界很大，但属于你的风景，只有你自己能定义。",
    translation:
      "The world is vast, but the scenery that belongs to you can only be defined by yourself.",
  },
  {
    text: "在平凡中寻找不平凡，是生活的艺术。",
    translation:
      "Finding the extraordinary in the ordinary is the art of life.",
  },
  {
    text: "你不需要成为别人，只需要成为更好的自己。",
    translation:
      "You don't need to become someone else; you just need to become a better version of yourself.",
  },
  // 可以添加更多标语...
];
